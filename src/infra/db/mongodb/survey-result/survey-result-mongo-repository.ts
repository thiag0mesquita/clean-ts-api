...
import { LoadSurveyResultRepository, SaveSurveyResultRepository } from '@/data/usecases/survey-result/save-survey-result/db-save-survey-result-protocols'
  ...
  async loadBySurveyId (surveyId: string): Promise<SurveyResultModel> {
    ...
    const query = new QueryBuilder()
      ...
      .project({
        ...
        date: '$_id.date',
        answers: {
          // map: pega um array e retorna um novo array modificado
          $map: {
            input: '$_id.answers',
            as: 'item',
            in: {
              // mergeObjects: adiciona mais propriedades em um array
              $mergeObjects: ['$$item', {
                count: {
                  $cond: {
                    if: {
      ...
      .project({
        ...
        date: '$_id.date',
        answers: {
          // reduce: pega vários arrays e transforma em um
          $reduce: {
            input: '$answers',
            initialValue: [],
            in: {
